...
public class Puzzle extends javax.swing.JFrame implements ActionListener  {
    ...
    public Puzzle() {
        ...
        //una forma de cambiar el icono de la tasa de cafe de java
        //setIconImage(new ImageIcon(getClass().getResource("../Images/icono1.jpg")).getImage());
...
//        File imageCheck = new File("Rompecabezas\\src\\Imagenes");
...
//           jugador = (String) JOptionPane.showInputDialog(null,"Congratulations you've ordered the puzzle. Enter your name: ",
//              "Puzzle",JOptionPane.INFORMATION_MESSAGE, new ImageIcon("src/Images/emoticon3.jpg"),null,"");
        ...
        try{
         ...
         {
            JOptionPane.showMessageDialog(this, "Error al grabar el nombre","Puzzle V 3.0.1",JOptionPane.ERROR_MESSAGE);
         }
          imprimirJugadores(); 
}
   ...
   private void imprimirJugadores(){
       // imprime el nombre y el tiempo que le tomo al jugador completar el puzzle en un txtArea
        ...
        //Font fuente = new Font("Tahoma",3,13);
        try{
            ...
            while(sc.hasNextLine())
            {
               ...
               //tres formas de poner el tipo de letra diferente 
               //txtArea.setFont(new java.awt.Font("Tahoma",3,13));
        ...
        }catch (Exception e)
        {
            ...
            JOptionPane.showMessageDialog(this, "Error al leer los datos","Puzzle V 3.0.1", JOptionPane.ERROR_MESSAGE);
        }
   }
